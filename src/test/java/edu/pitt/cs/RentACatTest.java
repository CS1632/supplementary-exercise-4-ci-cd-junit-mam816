...
public class RentACatTest {
	...
	public void testGetCatNullNumCats0() {
		Cat c = r.getCat(2);
		assertNull("Returned cat is null", c);
	}
	...
	public void testCatAvailableFalseNumCats0() {
		boolean tf = r.catAvailable(2);
		assertFalse("Cat with ID 2 is available", tf);
	}
	...
	public void testCatAvailableTrueNumCats3() {
		...
		boolean tf = r.catAvailable(2);
		assertTrue("Cat with given ID is not available", tf);
	}
	...
	public void testCatAvailableFalseNumCats3() {
		...
		boolean tf = r.catAvailable(2);
		assertFalse("Cat with given ID is available", tf);
	}
	...
	public void testCatExistsFalseNumCats0() {
		boolean tf = r.catExists(2);
		assertFalse("Cat with given ID exists", tf);
	}
	...
	public void testCatExistsTrueNumCats3() {
		...
		r.addCat(c2);
		r.addCat(c3);
		//System.out.println("testCatExistsTrueNumCats3");
		boolean tf = r.catExists(2);
		assertTrue("Cat with given ID does not exist", tf);
	}
	...
	public void testRentCatFailureNumCats3() {
		...
		r.addCat(c3);
		Mockito.when(c2.getRented()).thenReturn(true);
		boolean tf = r.rentCat(2);
		assertFalse("Cat should not be able to be rented", tf);
	...
	public void testReturnCatFailureNumCats0() {
		boolean tf = r.returnCat(2);
		assertFalse("The cat exists when it shouldn't", tf);
	}
	...
	public void testReturnCatNumCats3() {
		...
		Mockito.when(c2.getRented()).thenReturn((true));
		boolean tf = r.returnCat(2);
		assertTrue("The cat was not returned", tf);

		//Test for if c1 or c3 are ever run
